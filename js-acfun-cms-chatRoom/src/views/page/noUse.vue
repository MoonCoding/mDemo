<template>
  <div class="app-container">
    ...
    <el-table :data="list" border style="width: 100%" class="account-table">
      ...
      <el-table-column prop="forbidTime" label="禁用时间" min-width="200"></el-table-column>
      <el-table-column prop="" label="操作" >
        <template scope="scope">
          <el-button @click="open2(scope.$index)" type="text" size="small">取消禁用</el-button>
        </template>
      </el-table-column>
    </el-table>
  ...
  methods: {
    ...
    open3() {
      this.$prompt('请输入聊天室名称', '聊天室信息', {
        ...
        cancelButtonText: '取消',
        inputPattern: '',
        inputErrorMessage: '聊天室名称最大12个字符哦~'
      }).then(({ value }) => {
        this.$message({
          type: 'success',
